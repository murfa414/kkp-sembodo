...
@if(!session()->has('kmeans_result'))
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden" style="background: linear-gradient(135deg, #2c3a63 0%, #571212 100%);">
...
@else
    ...
    <div class="row">
        <a href="{{ route('laporan.pdf') }}" class="btn btn-dark mb-3 fw-bold px-4" target="_blank">
            <i class="fas fa-file-pdf me-2"></i> Unduh Laporan
        </a>
